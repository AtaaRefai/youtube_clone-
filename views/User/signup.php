...
<div class="login-page">
  <div class="form">
    <form class="login-form" action="http://localhost/videotube/index.php/User_Controller/signup" method="post">
      ...
      <p class="message">Already registered? <a href='http://localhost/videotube/index.php/User_Controller/index'>Login</a></p>
    </form>
  </div>
</div>
</body>
