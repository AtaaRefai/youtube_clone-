...
<html>
	<head>
		...
		<link rel="shortcut icon" type="image/x-icon" href="/public/images/pageicon.png" />
		<link href="/public/css/style.css" rel="stylesheet" type="text/css"  media="all" />
		<link href="/public/css/style3.css" rel="stylesheet" type="text/css"  media="all" />
	...
	<div class="wrap">
		...
		<div class="header">
			<!----start-Logo---->
			<div class="logo">
				<a href="index.php"><img src="/public/images/logo.png" title="logo" /></a>
			</div>
			<!----End-Logo---->
			<!----start-top-nav---->
			<div class="top-nav">
